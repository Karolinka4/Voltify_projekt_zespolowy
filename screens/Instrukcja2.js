    ...
    return (
        <View style={[styles.instrukcja1, styles.icon1Layout]}>
            <View style={styles.parent}>
                ...
                >{`Aplikacja zawiera funkcję “Energia” która umożliwia nam kontrolowanie i monitoring zużywania energii w czasie roku, miesięcy, tygodni oraz dni.
...
`}
            ...
            <Pressable style={styles.strzakaPrawaWrapper}>
                <Pressable
                    ...
                    onPress={() => navigation.navigate("Instrukcja3")}
                >
                    <Image
